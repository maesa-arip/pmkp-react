...
export default function Index(props) {
    ...
    const openEditDialog = (controlValue) => {
        setState(controlValue);
        setIsOpenEditDialog(true);
    };
    const openDestroyDialog = (controlValue) => {
        setState(controlValue);
        setIsOpenDestroyDialog(true);
    };

    const destroycontrolValue = () => {
        router.delete(route("controlValues.destroy", state.id), {
    ...
    return (
        <>
            <Head title="Nilai Controllability" />
            <AddModal
                isOpenAddDialog={isOpenAddDialog}
                setIsOpenAddDialog={setIsOpenAddDialog}
                size="xl"
                title="Tambah Nilai Controllability"
            >
                <Create
                    ShouldMap={type}
                    isOpenAddDialog={isOpenAddDialog}
            ...
            <EditModal
                ...
                size="xl"
                title="Edit Nilai Controllability"
            >
                <Edit
                    model={state}
                    ShouldMap={type}
            ...
            <DestroyModal
                ...
                size="2xl"
                title="Delete Nilai Controllability"
                warning="Yakin hapus data ini ?"
            >
                <DangerButton className="ml-2" onClick={destroycontrolValue}>
                    Delete
                </DangerButton>
            </DestroyModal>
                                            ...
                                            {controlValues.map(
                                                (controlValue, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            {
                                                                controlValue.type == 1 ? 'Klinis' : 'Non Klinis'
                                                            }
                                                        </td>
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            {
