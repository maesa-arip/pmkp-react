...
export default function Index(props) {
    ...
    const openEditDialog = (probabilityValue) => {
        setState(probabilityValue);
        setIsOpenEditDialog(true);
    };
    const openDestroyDialog = (probabilityValue) => {
        setState(probabilityValue);
        setIsOpenDestroyDialog(true);
    };

    const destroyprobabilityValue = () => {
        router.delete(route("probabilityValues.destroy", state.id), {
    ...
    return (
        <>
            ...
            >
                <DangerButton className="ml-2" onClick={destroyprobabilityValue}>
                    Delete
                </DangerButton>
            </DestroyModal>
                                ...
                                <div className="border-b border-gray-200 shadow sm:rounded-lg">
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            {probabilityValues.map(
                                                (probabilityValue, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            {
                                                                probabilityValue.name
                                                            }
                                                        </td>
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            {
                                                                probabilityValue.type == 1 ? 'Klinis' : 'Non Klinis'
                                                            }
                                                        </td>
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            {
                                                                probabilityValue.joined
                                                            }
                                                        </td>
                                                        <td>
                                                            <Dropdown>
