...
export default function Index(props) {
    const { data: Sources, meta, filtered, attributes } = props.identificationSources;
    ...
    const reload = useCallback(
        debounce((query) => {
            router.get(
                route("identificationSources.index"),
    ...
    const openDestroyDialog = (source) => {
        setState(source);
        setIsOpenDestroyDialog(true);
    };

    const destroysource = () => {
        router.delete(route("identificationSources.destroy", state.id), {
    ...
    return (
        <>
            <Head title="Sumber Identifikasi" />
            <AddModal
                isOpenAddDialog={isOpenAddDialog}
                setIsOpenAddDialog={setIsOpenAddDialog}
                size="xl"
                title="Tambah Sumber Identifikasi"
            >
                <Create
                    isOpenAddDialog={isOpenAddDialog}
                    setIsOpenAddDialog={setIsOpenAddDialog}
            ...
            <EditModal
                ...
                size="xl"
                title="Edit Sumber Identifikasi"
            >
                <Edit
                    model={state}
                    isOpenEditDialog={isOpenEditDialog}
            ...
            <DestroyModal
                ...
                size="2xl"
                title="Delete Sumber Identifikasi"
                warning="Yakin hapus data ini ?"
            >
                <DangerButton className="ml-2" onClick={destroysource}>
                    Delete
                </DangerButton>
            </DestroyModal>
