...
export default function Index(props) {
    const { data: Varieties, meta, filtered, attributes } = props.riskVarieties;
    ...
    const openDestroyDialog = (variety) => {
        setState(variety);
        setIsOpenDestroyDialog(true);
    };

    const destroyvariety = () => {
        router.delete(route("riskVarieties.destroy", state.id), {
    ...
    return (
        <>
            ...
            >
                <DangerButton className="ml-2" onClick={destroyvariety}>
                    Delete
                </DangerButton>
            </DestroyModal>
