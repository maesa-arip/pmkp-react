...
export default function Index(props) {
    const { data: Types, meta, filtered, attributes } = props.riskTypes;
    ...
    const openDestroyDialog = (type) => {
        setState(type);
        setIsOpenDestroyDialog(true);
    };

    const destroytype = () => {
        router.delete(route("riskTypes.destroy", state.id), {
    ...
    return (
        <>
            ...
            >
                <DangerButton className="ml-2" onClick={destroytype}>
                    Delete
                </DangerButton>
            </DestroyModal>
