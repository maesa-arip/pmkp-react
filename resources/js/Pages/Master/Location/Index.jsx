...
export default function Index(props) {
    const { data: locations, meta, filtered, attributes } = props.locations;
    ...
    const openDestroyDialog = (location) => {
        setState(location);
        setIsOpenDestroyDialog(true);
    };

    const destroylocation = () => {
        router.delete(route("locations.destroy", state.id), {
    ...
    return (
        <>
            ...
            >
                <DangerButton className="ml-2" onClick={destroylocation}>
                    Delete
                </DangerButton>
            </DestroyModal>
