...
export default function Index(props) {
    const columns = [
        ...
        { key: "kode", label: "Kode", sortField: "kode", className: "w-[110px]" },
        {
            ...
            render: (row) => <ColorBadge value={row.warna} />,
        },
        {
            key: "name",
            label: "Klinis",
            ...
            render: (row) => <TextBadge value={row.name} />,
        },
        {
            key: "name_nonklinis",
            label: "Non Klinis",
            ...
            className: "min-w-[180px]",
            render: (row) => <TextBadge value={row.name_nonklinis} />,
        },
        {
            ...
            render: (row) => <TextBadge value={row.name_nonklinis_pergub} />,
        },
        {
            key: "name_ikp",
            label: "IKP",
            ...
            render: (row) => <TextBadge value={row.name_ikp} />,
        },
        {
            key: "name_bpkp",
            label: "BPKP",
            sortField: "name_bpkp",
            className: "min-w-[180px]",
            render: (row) => <TextBadge value={row.name_bpkp} />,
        },
    ];
