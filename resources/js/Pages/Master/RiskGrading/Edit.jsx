...
export default function Edit({ setIsOpenEditDialog, model, activeType = null }) {
    ...
    const { data, setData, put, reset, errors, transform } = useForm({
        ...
        name_klinis_pergub: model.name_klinis_pergub || "",
        warna_klinis_pergub: model.warna_klinis_pergub || "",
        name_nonklinis_pergub: model.name_nonklinis_pergub || "",
        warna_nonklinis_pergub: model.warna_nonklinis_pergub || "",
        name_klinis_bpkp: model.name_klinis_bpkp || "",
        warna_klinis_bpkp: model.warna_klinis_bpkp || "",
        name_nonklinis_bpkp: model.name_nonklinis_bpkp || "",
        warna_nonklinis_bpkp: model.warna_nonklinis_bpkp || "",
