...
export default function Index(props) {
    const { data: Jenis, meta, filtered, attributes } = props.jenisSebabs;
    ...
    const openEditDialog = (sebab) => {
        setState(sebab);
        setIsOpenEditDialog(true);
    };
    const openDestroyDialog = (sebab) => {
        setState(sebab);
        setIsOpenDestroyDialog(true);
    };

    const destroysebab = () => {
        router.delete(route("jenisSebabs.destroy", state.id), {
    ...
    return (
        <>
            ...
            >
                <DangerButton className="ml-2" onClick={destroysebab}>
                    Delete
                </DangerButton>
            </DestroyModal>
