...
export default function MRTerbaruKlinis({ setIsOpenAddDialog }) {
    ...
    const handleSubmit = (e) => {
        ...
        setExportError("");
        const url = "/riskregisterklinismrterbaru";
        ...
        axios
            ...
            .then((response) => {
                ...
                link.setAttribute("download", "Laporan MR Terbaru Klinis " + period.startDate.slice(0, 4) + ".xlsx");
