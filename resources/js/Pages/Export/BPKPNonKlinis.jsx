...
export default function BPKPNonKlinis({ setIsOpenAddDialog }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const url = "/riskregisternonklinisbpkp";
        ...
        axios
            ...
            .then((response) => {
                ...
                link.setAttribute("download", "Form Manajemen Risiko BPKP Non Klinis.xlsx");
