...
export default function PDSA({ setIsOpenAddDialog }) {
    ...
    const handleSubmit = (e) => {
        ...
        const formattedEndDate = data.endDate ? new Date(data.endDate).toLocaleDateString("en-CA", formatDate) : '';
        ...
        axios
            ...
            .then((response) => {
                ...
                link.setAttribute("download", `Form PDSA ${formattedStartDate}-${formattedEndDate}.pdf`);
