...
export default function MRTerbaruNonKlinis({ setIsOpenAddDialog }) {
    ...
    const handleSubmit = (e) => {
        ...
        setExportError("");
        const url = "/riskregisternonklinismrterbaru";
        ...
        axios
            ...
            .then((response) => {
                ...
                link.setAttribute("download", "Laporan MR Terbaru Non Klinis " + period.startDate.slice(0, 4) + ".xlsx");
