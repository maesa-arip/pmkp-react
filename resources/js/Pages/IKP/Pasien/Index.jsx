...
const getGradingRowStyle = (gradingName) => {
                                    ...
                                    {IkpPasien.map((item, index) => {
                                        ...
                                        return (
                                            <tr
                                                ...
                                                className={`group transition-colors cursor-pointer ${isSelected ? gradingAwalRowClass.selected : gradingAwalRowClass.row}`}
                                            >
                                                {/* Col 1 (Sticky) */}
                                                <td
                                                ...
                                                <td className="px-5 py-4 align-middle border-r border-slate-100 dark:border-slate-800/80 whitespace-nowrap">
                                                    ...
                                                    <div className={`text-[11px] font-medium ${rowMutedTextClass} ml-5 mt-0.5`}>
                                                        Jam:{" "}
                                                        {moment(
                                                            item.tanggal_insiden,
                                                        ).format("HH:mm")}
                                                ...
                                                <td className="px-5 py-4 align-middle border-r border-slate-100 dark:border-slate-800/80 whitespace-nowrap">
                                                    <span className={`text-sm font-semibold ${rowTextClass}`}>
                                                        {moment(
                                                            item.created_at,
                                                        ).format("DD-MM-YYYY")}
                                                    </span>
                                                ...
                                                <td className="px-5 py-4 whitespace-normal align-middle border-r border-slate-100 dark:border-slate-800/80">
                                                    <span className={`block text-sm font-bold break-words ${rowTextClass}`}>
                                                        {item.lokasi_name ||
                                                            "-"}
                                                    </span>
                                                </td>
                                                ...
                                                <td className="px-5 py-4 border-r border-slate-100 dark:border-slate-800/80 align-middle whitespace-normal min-w-[200px] max-w-[300px]">
                                                    <div className="mb-1">
                                                        <span className={`text-[10px] font-bold uppercase tracking-widest ${rowMutedTextClass} block mb-0.5`}>
                                                            Jenis:
                                                        </span>
                                                        <span className={`text-xs font-semibold ${rowTextClass}`}>
                                                            {item.jenis_insiden
                                                                ?.name || "-"}
                                                        </span>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <span className={`text-[13px] font-medium ${rowTextClass} line-clamp-2 leading-snug`}>
                                                            {item.insiden ||
                                                                "-"}
                                                        </span>
                                                    </div>
                                                ...
                                                <td className="px-5 py-4 whitespace-normal align-middle border-r border-slate-100 dark:border-slate-800/80">
                                                    <span className={`block text-xs font-semibold break-words ${rowTextClass}`}>
                                                        {item.penanggung
                                                            ?.name || "-"}
                                                    </span>
                                                </td>
                                                ...
                                                <td className="px-5 py-4 text-center align-middle border-r border-slate-100 dark:border-slate-800/80">
                                                    <span
                                                        className={`inline-flex px-2.5 py-1 text-[10px] font-black uppercase tracking-widest rounded-md border ${rowBadgeClass}`}
                                                    >
                                                        {gradingAwalName ||
                                                            "UNRATED"}
                                                    </span>
                                                ...
                                                <td className="px-5 py-4 text-center align-middle border-r border-slate-100 dark:border-slate-800/80">
                                                    {item.hasil_grading ? (
                                                        ...
                                                        <span className={`inline-flex px-2.5 py-1 text-[10px] font-black uppercase tracking-widest rounded-md border ${rowBadgeClass}`}>
                                                            Sdh Inv. (Blm
                                                            Grading)
                                                        </span>
                                                    ) : (
