...
export default function Index(props) {
    const { data: IkpDampak, meta, filtered, attributes } = props.IkpDampak;
    ...
    const openEditDialog = (IkpDampak) => {
        setState(IkpDampak);
        setIsOpenEditDialog(true);
    };
    const openDestroyDialog = (IkpDampak) => {
        setState(IkpDampak);
        setIsOpenDestroyDialog(true);
    };

    const destroyIkpDampak = () => {
        router.delete(route("IkpDampak.destroy", state.id), {
    ...
    return (
        <>
            ...
            >
                <DangerButton className="ml-2" onClick={destroyIkpDampak}>
                    Delete
                </DangerButton>
            </DestroyModal>
                    ...
                    <Table overflow="none">
                        <Table.Thead>
                            <Table.Tr>
                                ...
                                <Table.Th onClick={() => sort("description")}>
                                    Keterangan
                        ...
                        <Table.Tbody>
                            {IkpDampak.map((IkpDampak, index) => (
                                <tr key={index}>
                                    ...
                                    <Table.Td>{IkpDampak.description}</Table.Td>
                                    <Table.Td>{IkpDampak.joined}</Table.Td>
                                    <Table.Td>
                                        <Dropdown>
                                            <Dropdown.Trigger>
                                                <button>
