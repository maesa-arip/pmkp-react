...
export default function Index(props) {
    ...
    const openEditDialog = (IkpGrupLayanan) => {
        setState(IkpGrupLayanan);
        setIsOpenEditDialog(true);
    };
    const openDestroyDialog = (IkpGrupLayanan) => {
        setState(IkpGrupLayanan);
        setIsOpenDestroyDialog(true);
    };

    const destroyIkpGrupLayanan = () => {
        router.delete(route("IkpGrupLayanan.destroy", state.id), {
    ...
    return (
        <>
            ...
            >
                <DangerButton className="ml-2" onClick={destroyIkpGrupLayanan}>
                    Delete
                </DangerButton>
            </DestroyModal>
            <div className="px-2 py-12 bg-white border rounded-xl">
                <div className="mx-auto sm:px-6 lg:px-8">
                    ...
                    <Table overflow="none">
                        ...
                        <Table.Tbody>
                            {IkpGrupLayanan.map((IkpGrupLayanan, index) => (
                                <tr key={index}>
                                    <Table.Td>
