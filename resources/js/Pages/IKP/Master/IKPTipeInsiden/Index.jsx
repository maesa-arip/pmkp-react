...
export default function Index(props) {
    ...
    const openEditDialog = (IkpTipeInsiden) => {
        setState(IkpTipeInsiden);
        setIsOpenEditDialog(true);
    };
    const openDestroyDialog = (IkpTipeInsiden) => {
        setState(IkpTipeInsiden);
        setIsOpenDestroyDialog(true);
    };

    const destroyIkpTipeInsiden = () => {
        router.delete(route("IkpTipeInsidens.destroy", state.id), {
    ...
    return (
        <>
            ...
            >
                <DangerButton className="ml-2" onClick={destroyIkpTipeInsiden}>
                    Delete
                </DangerButton>
            </DestroyModal>
            <div className="px-2 py-12 bg-white border rounded-xl">
                <div className="mx-auto sm:px-6 lg:px-8">
                    ...
                    <Table overflow="none">
                        ...
                        <Table.Tbody>
                            {IkpTipeInsiden.map((IkpTipeInsiden, index) => (
                                <tr key={index}>
                                    <Table.Td>
