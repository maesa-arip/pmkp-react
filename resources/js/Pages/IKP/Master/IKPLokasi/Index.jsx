...
export default function Index(props) {
    ...
    const openEditDialog = (IkpLokasi) => {
        setState(IkpLokasi);
        setIsOpenEditDialog(true);
    };
    const openDestroyDialog = (IkpLokasi) => {
        setState(IkpLokasi);
        setIsOpenDestroyDialog(true);
    };

    const destroyIkpLokasi = () => {
        router.delete(route("IkpLokasi.destroy", state.id), {
    ...
    return (
        <>
            ...
            >
                <DangerButton className="ml-2" onClick={destroyIkpLokasi}>
                    Delete
                </DangerButton>
            </DestroyModal>
