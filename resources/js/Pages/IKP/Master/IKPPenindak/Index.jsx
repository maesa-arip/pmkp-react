...
export default function Index(props) {
    ...
    const openEditDialog = (IkpPenindak) => {
        setState(IkpPenindak);
        setIsOpenEditDialog(true);
    };
    const openDestroyDialog = (IkpPenindak) => {
        setState(IkpPenindak);
        setIsOpenDestroyDialog(true);
    };

    const destroyIkpPenindak = () => {
        router.delete(route("IkpPenindak.destroy", state.id), {
    ...
    return (
        <>
            ...
            >
                <DangerButton className="ml-2" onClick={destroyIkpPenindak}>
                    Delete
                </DangerButton>
            </DestroyModal>
            <div className="px-2 py-12 bg-white border rounded-xl">
                <div className="mx-auto sm:px-6 lg:px-8">
                    ...
                    <Table overflow="none">
                        ...
                        <Table.Tbody>
                            {IkpPenindak.map((IkpPenindak, index) => (
                                <tr key={index}>
                                    <Table.Td>
