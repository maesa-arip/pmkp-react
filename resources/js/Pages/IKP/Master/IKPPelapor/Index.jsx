...
export default function Index(props) {
    ...
    const openEditDialog = (IkpPelapor) => {
        setState(IkpPelapor);
        setIsOpenEditDialog(true);
    };
    const openDestroyDialog = (IkpPelapor) => {
        setState(IkpPelapor);
        setIsOpenDestroyDialog(true);
    };

    const destroyIkpPelapor = () => {
        router.delete(route("IkpPelapor.destroy", state.id), {
    ...
    return (
        <>
            ...
            >
                <DangerButton className="ml-2" onClick={destroyIkpPelapor}>
                    Delete
                </DangerButton>
            </DestroyModal>
            <div className="px-2 py-12 bg-white border rounded-xl">
                <div className="mx-auto sm:px-6 lg:px-8">
                    ...
                    <Table overflow="none">
                        ...
                        <Table.Tbody>
                            {IkpPelapor.map((IkpPelapor, index) => (
                                <tr key={index}>
                                    <Table.Td>
