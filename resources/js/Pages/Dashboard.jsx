                        ...
                        <ol>
                            <li className="border-l-2 border-purple-600">
                                <div className="md:flex flex-start">
                                    ...
                                    <div className="block max-w-xl p-6 mb-10 ml-6 bg-gray-100 rounded-lg shadow-lg">
                                        ...
                                        <p className="mb-6 text-gray-700">
                                            ...
                                            scelerisque diam non nisi semper, et
                                            elementum lorem ornare. Maecenas
                                            placerat facilisis mollis. Duis
                                            ...
                                            {riskRegisterKlinis.map(
                                                (
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            {
                                                                riskregisterklinis1.currently_id == 1 ? <span className="px-2 py-0.5 ml-auto text-xs font-medium tracking-wide text-red-500 bg-red-50 rounded-full">'Sedang Terjadi</span>: 'Tidak Sedang Terjadi'
                                                            }
                                                        </td>
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            {
