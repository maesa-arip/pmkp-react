...
export default function Edit({ setIsOpenEditDialog, model, ShouldMap }) {
    const { data, setData, put, reset, errors } = useForm({
        ...
        probabilitas_responden1: model.fgdresidual?.probabilitas_responden1 ?? '',
        probabilitas_responden2: model.fgdresidual?.probabilitas_responden2 ?? '',
        probabilitas_responden3: model.fgdresidual?.probabilitas_responden3 ?? '',
        probabilitas_responden4: model.fgdresidual?.probabilitas_responden4 ?? '',
        probabilitas_responden5: model.fgdresidual?.probabilitas_responden5 ?? '',
        probabilitas_responden6: model.fgdresidual?.probabilitas_responden6 ?? '',
        probabilitas_responden7: model.fgdresidual?.probabilitas_responden7 ?? '',
        probabilitas_responden8: model.fgdresidual?.probabilitas_responden8 ?? '',
    });
