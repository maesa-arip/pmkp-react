...
export default function Form({
    ...
    const [selectedImpact1, setSelectedImpact1] = useState(() => {
        if (model) return ShouldMap.impactValues.find((x) => x.id === model.osd1_dampak);
        return defaultValue[0];
    });
    const [selectedProbability1, setSelectedProbability1] = useState(() => {
        if (model) return ShouldMap.probabilityValues.find((x) => x.id === model.osd1_probabilitas);
        return defaultValue[0];
    });
    const [selectedControl1, setSelectedControl1] = useState(() => {
        if (model) return ShouldMap.controlValues.find((x) => x.id === model.osd1_controllability);
        return defaultValue[0];
    });
    ...
    const [selectedPerluPenanganan, setSelectedPerluPenanganan] = useState(() => {
        if (model) return ShouldMap.perluPenanganan.find((x) => x.id === model.perlu_penanganan_id);
        return defaultValue[0];
    });
            ...
            <div className="flex-1 p-4 space-y-6 overflow-y-auto sm:p-6 custom-scrollbar">
                ...
                <div className={`${sectionCardClass} relative z-[50]`}>
                    <div className={sectionHeaderClass}>
                        ...
                        <p className="mt-0.5 text-xs font-medium text-slate-500 dark:text-slate-400">Lengkapi parameter utama dan konteks insiden di bawah ini.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-6 p-6 md:grid-cols-12">
                        ...
                        <div className="col-span-12 mt-2 md:col-span-6 relative z-[51]">
                        ...
                        <div className="col-span-12 flex flex-col relative z-[49]">
                ...
                <div className={`${sectionCardClass} relative z-[40]`}>
                    ...
                    <div className="relative z-10 grid grid-cols-1 gap-6 p-6 md:grid-cols-12">
                        ...
                        {/* FIX BUG: Menghapus TextInputWithError diganti TextInput standar */}
