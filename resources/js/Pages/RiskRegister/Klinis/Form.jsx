...
export default function Form({
    ...
    const [selectedCategory, setSelectedCategory] = useState(() => {
        if (model) return ShouldMap.riskCategories.find((x) => x.id === model.risk_category_id);
        return defaultValue[0];
    });
    const [selectedSource, setSelectedSource] = useState(() => {
        if (model) return ShouldMap.identificationSources.find((x) => x.id === model.identification_source_id);
        return defaultValue[0];
    });
    const [selectedVariety, setSelectedVariety] = useState(() => {
        if (model) return ShouldMap.riskVarieties.find((x) => x.id === model.risk_variety_id);
        return defaultValue[0];
    });
    const [selectedType, setSelectedType] = useState(() => {
        if (model) return ShouldMap.riskTypes.find((x) => x.id === model.risk_type_id);
        return defaultValue[0];
    });
    ...
    const [selectedOpsiPengendalian, setSelectedOpsiPengendalian] = useState(() => {
        if (model) return ShouldMap.opsiPengendalian.find((x) => x.id === model.opsi_pengendalian_id);
        return defaultValue[0];
    });
    const [selectedPembiayaanRisiko, setSelectedPembiayaanRisiko] = useState(() => {
        if (model) return ShouldMap.pembiayaanRisiko.find((x) => x.id === model.pembiayaan_risiko_id);
        return defaultValue[0];
    });
    const [selectedEfektif, setSelectedEfektif] = useState(() => {
        if (model) return ShouldMap.efektif.find((x) => x.id === model.efektif_id);
        return defaultValue[0];
    });
    const [selectedJenisPengendalian, setSelectedJenisPengendalian] = useState(() => {
        if (model) return ShouldMap.jenisPengendalian.find((x) => x.id === model.jenis_pengendalian_id);
        return defaultValue[0];
    });
    const [selectedWaktuPengendalian, setSelectedWaktuPengendalian] = useState(() => {
        if (model) return ShouldMap.waktuPengendalian.find((x) => x.id === model.waktu_pengendalian_id);
        return defaultValue[0];
    });
    const cUcOptions = [
        { value: "C", label: "C" },
            ...
            <div className="flex-1 p-4 space-y-6 overflow-y-auto sm:p-6 custom-scrollbar">
                ...
                <div className={`${sectionCardClass} relative z-[50]`}>
                    <div className={sectionHeaderClass}>
                        <h3 className="text-base font-bold text-slate-900 dark:text-white">Informasi Dasar Risiko</h3>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-6 p-6 md:grid-cols-12">
                        ...
                        <div className="col-span-12 flex flex-col relative z-[54]">
                        ...
                        {data.risk_category_id === 6 && (
                            <div className="col-span-12 flex flex-col gap-1.5 p-5 bg-orange-50 dark:bg-orange-500/10 border border-orange-200 dark:border-orange-500/30 rounded-xl mt-2 relative z-[50]">
                        ...
                        <div className="col-span-12 md:col-span-12 flex flex-col relative z-[48]">
                        ...
                        <div className="col-span-12 flex flex-col relative z-[45]">
                ...
                <div className={`${sectionCardClass} relative z-[40]`}>
                    ...
                    <div className="relative z-10 grid grid-cols-1 gap-6 p-6 md:grid-cols-12">
                        ...
                        <div className="col-span-12 md:col-span-6 flex flex-col relative z-[44]">
                ...
                {/* --- SECTION 4: RENCANA TINDAK PENGENDALIAN --- */}
                <div className={`${sectionCardClass} relative z-[20]`}>
                    <div className={sectionHeaderClass}>
                        <h3 className="text-base font-bold text-slate-900 dark:text-white">Rencana Tindak Pengendalian</h3>
                    </div>
                    
                    <div className="relative z-10 grid grid-cols-1 gap-6 p-6 md:grid-cols-12">
                        <div className="col-span-12 flex flex-col relative z-[29]">
                        ...
                        <div className="col-span-12 md:col-span-6 flex flex-col relative z-[21]">
                            <label className={labelClass}>Media/bentuk sarana pengkomunikasian</label>
                            <TextAreaInput id="media_pengkomunikasian" value={data.media_pengkomunikasian} handleChange={(e) => setData("media_pengkomunikasian", e.target.value)} rows={2} className={inputClass} placeholder="Tuliskan media atau sarana komunikasi..." />
                            <InputError message={errors.media_pengkomunikasian} className="mt-1" />
                        </div>

                        <div className="col-span-12 md:col-span-6 flex flex-col relative z-[20]">
                            <label className={labelClass}>Penyedia Informasi</label>
                            <TextAreaInput id="penyedia_informasi" value={data.penyedia_informasi} handleChange={(e) => setData("penyedia_informasi", e.target.value)} rows={2} className={inputClass} placeholder="Tuliskan penyedia informasi..." />
                            <InputError message={errors.penyedia_informasi} className="mt-1" />
                        </div>

                        <div className="col-span-12 md:col-span-6 flex flex-col relative z-[19]">
                            <label className={labelClass}>Penerima Informasi</label>
                            <TextAreaInput id="penerima_informasi" value={data.penerima_informasi} handleChange={(e) => setData("penerima_informasi", e.target.value)} rows={2} className={inputClass} placeholder="Tuliskan penerima informasi..." />
                            <InputError message={errors.penerima_informasi} className="mt-1" />
                        </div>
                        ...
                        <div className="col-span-12 md:col-span-6 flex flex-col relative z-[14]">
                            <label className={labelClass}>Jenis Pengendalian</label>
                        ...
                        <div className="col-span-12 md:col-span-6 flex flex-col relative z-[11]">
