...
export default function Edit({ setIsOpenEditDialog, model, ShouldMap }) {
    ...
    const { data, setData, put, reset, errors } = useForm({
        ...
        target_waktu: safeModel.target_waktu || "",
        efek: safeModel.efek || "",
        ...
        celah_pengendalian: safeModel.celah_pengendalian || "",
        media_pengkomunikasian: safeModel.media_pengkomunikasian || "",
        penyedia_informasi: safeModel.penyedia_informasi || "",
        penerima_informasi: safeModel.penerima_informasi || "",
    ...
    const onSubmit = (e) => {
        ...
        put(route("riskRegisterNonKlinis.update", safeModel.id), {
            data,
            onSuccess: () => {
                reset();
                setIsOpenEditDialog(false);
    ...
    useEffect(() => {
        ...
        setData({
            ...
            celah_pengendalian: model.celah_pengendalian,
            media_pengkomunikasian: model.media_pengkomunikasian,
            penyedia_informasi: model.penyedia_informasi,
            penerima_informasi: model.penerima_informasi,
