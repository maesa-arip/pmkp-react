...
export default function Form({
    ...
    // Auto-generate Pernyataan Risiko (Persis bawaan)
    useEffect(() => {
            ...
            <div className="flex-1 p-4 space-y-6 overflow-y-auto sm:p-6 custom-scrollbar">
                ...
                <div className={`${sectionCardClass} overflow-hidden`}>
                    ...
                    <div className="p-6 pl-8">
                        <div className="flex items-center text-[10px] font-black uppercase tracking-widest text-sky-600 dark:text-sky-400 mb-2">
                            <DocumentTextIcon className="w-4 h-4 mr-1.5" />
                            Data Pernyataan Risiko
                        </div>
                        <TextAreaInput
                ...
                <div className={`${sectionCardClass} border-sky-200 dark:border-sky-500/30 overflow-hidden mb-4`}>
                    <div className="px-6 py-5 border-b bg-sky-50/50 dark:bg-sky-500/5 border-sky-100 dark:border-sky-500/20">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h3 className="text-base font-bold text-slate-900 dark:text-white">Verifikasi Admin IKP</h3>
                    ...
                    <div className="grid grid-cols-1 gap-6 p-6 md:grid-cols-12 bg-white dark:bg-[#0f172a]">
                        <div className="relative flex flex-col col-span-12 z-[40]">
                            ...
                            <TextAreaInput
                                ...
                                placeholder="Masukkan catatan hasil pengawasan..."
                            />
