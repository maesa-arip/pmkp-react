...
export default function Index(props) {
    ...
    return (
        <div className="relative min-h-screen p-0 font-sans bg-transparent dark:bg-transparent text-slate-900 dark:text-slate-100 sm:p-2">
            <Head title="Verifikasi Admin Risiko" />
            
            <EditModal isOpenEditDialog={isOpenVerification} setIsOpenEditDialog={setIsOpenVerification} size="max-w-6xl" title="Verifikasi Admin: Risiko Sedang Terjadi">
                ...
                <div className="bg-white dark:bg-[#0f172a] border border-slate-200/80 dark:border-slate-800/80 rounded-2xl p-6 shadow-sm relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col justify-between gap-5 md:flex-row md:items-end">
                        <div className="space-y-1.5">
                            ...
                            <h2 className="text-2xl font-black tracking-tight text-slate-900 dark:text-slate-50">Verifikasi Admin IKP</h2>
                            <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Verifikasi tindakan pengendalian dan status risiko oleh administrator.</p>
                        </div>
                    ...
                    {riskRegisterKlinis.length === 0 ? (
                        <div className="absolute inset-0 z-0 flex flex-col items-center justify-center p-6 text-center">
                            ...
                            <p className="max-w-sm mt-2 text-sm font-medium text-slate-500 dark:text-slate-400">
                                {params.q ? "Pencarian Anda tidak menemukan hasil yang cocok." : "Belum ada risiko sedang terjadi yang memerlukan verifikasi."}
                            </p>
                        </div>
                    ) : (
                        <div className="relative z-10 pb-32 overflow-x-auto custom-scrollbar">
                            <table className="w-full text-sm text-left border-collapse whitespace-nowrap min-w-max">
                                <thead className="bg-slate-50 dark:bg-[#09090b]">
                                    <tr>
                                        <th className="px-4 py-3.5 border-b border-r border-slate-200 dark:border-slate-800/80 w-12 text-center text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest sticky left-0 z-20 bg-slate-50 dark:bg-[#09090b]">#</th>
                                        <th className="px-4 py-3.5 border-b border-r border-slate-200 dark:border-slate-800/80 cursor-pointer group hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors w-32" onClick={() => sort("tgl_register")}>
                                        ...
                                        <th className="px-4 py-3.5 border-b border-r border-slate-200 dark:border-slate-800/80 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest text-center w-36">
                                            Status & Grading
                                        </th>
                                        <th className="px-4 py-3.5 border-b border-r border-slate-200 dark:border-slate-800/80 cursor-pointer group hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors max-w-[300px]" onClick={() => sort("pernyataan_risiko")}>
                                            <div className="flex items-center text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">
                                                Konteks Risiko
                                        ...
                                        {/* Kumpulan Data Evaluasi (Dipersingkat agar tidak kepanjangan) */}
                                        <th className="px-4 py-3.5 border-b border-r border-slate-200 dark:border-slate-800/80 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest text-center">OSD 1 (Awal)</th>
                                        <th className="px-4 py-3.5 border-b border-r border-slate-200 dark:border-slate-800/80 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest text-center">OSD 2 (Residu)</th>
                                        <th className="px-4 py-3.5 border-b border-r border-slate-200 dark:border-slate-800/80 cursor-pointer group hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors max-w-[250px]" onClick={() => sort("pengendalian_risiko")}>
                                            <div className="flex items-center text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">
                                                Pengendalian & PIC
                                ...
                                <tbody className="divide-y divide-slate-100 dark:divide-slate-800/80">
                                    {riskRegisterKlinis.map((item, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <td className={`px-4 py-4 text-center border-r border-slate-100 dark:border-slate-800/80 align-middle sticky left-0 bg-clip-padding ${isSelected ? "bg-sky-50 dark:bg-[#1e293b]" : "bg-white dark:bg-[#0f172a] group-hover:bg-slate-50 dark:group-hover:bg-[#161f33]"} shadow-[4px_0_10px_-4px_rgba(0,0,0,0.05)] z-10`}>
                                                    <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 bg-slate-100 dark:bg-slate-800 px-2 py-1 rounded">
                                                        {meta.from + index}
                                                    </span>
                                                </td>

                                                <td className="px-4 py-4 align-top border-r border-slate-100 dark:border-slate-800/80 whitespace-nowrap">
                                                    <span className="text-sm font-bold text-slate-800 dark:text-slate-200">
                                                        {moment(item.tgl_register).format("DD MMM YYYY")}
                                                    </span>
                                                </td>

                                                <td className="px-4 py-4 text-center align-top border-r border-slate-100 dark:border-slate-800/80">
                                                ...
                                                <td className="px-4 py-4 border-r border-slate-100 dark:border-slate-800/80 align-top whitespace-normal max-w-[300px]">
                                                    <div className="mb-2">
                                                ...
                                                <td className="px-4 py-4 border-r border-slate-100 dark:border-slate-800/80 align-top whitespace-normal max-w-[250px]">
                                                    <div className="mb-2">
                                                    ...
                                                    <div className="pt-2 mt-auto border-t border-slate-100 dark:border-slate-800/80">
                                                        ...
                                                        <span className="text-xs font-bold text-sky-700 dark:text-sky-400">{item.user?.name || '-'}</span>
                                                    </div>
                                                </td>
                                                    ...
                                                    <div className="relative inline-block text-left" onClick={(e) => e.stopPropagation()}>
                                                        ...
                                                        {openDropdownId === item.id && (
                                                            <div className="absolute right-0 z-[100] w-48 mt-2 origin-top-right bg-white border border-slate-200 rounded-xl shadow-lg dark:bg-[#1e293b] dark:border-slate-700 ring-1 ring-black ring-opacity-5 focus:outline-none divide-y divide-slate-100 dark:divide-slate-700/80">
                                                                <div className="py-1">
                                                                    <button onClick={() => { openVerification(item); setOpenDropdownId(null); }} className="flex items-center w-full px-4 py-2.5 text-xs font-bold text-sky-600 transition-colors hover:bg-sky-50 dark:hover:bg-sky-500/10 dark:text-sky-400 group">
                ...
                <>
                    ...
                    <div className="fixed inset-y-2 right-2 sm:right-4 z-50 w-[calc(100%-1rem)] sm:w-[500px] bg-white dark:bg-[#0f172a] shadow-2xl border border-slate-200 dark:border-slate-800 rounded-2xl flex flex-col transition ease-in-out animate-slide-in overflow-hidden">
                        ...
                        <div className="flex-1 p-6 space-y-6 overflow-y-auto custom-scrollbar bg-slate-50/50 dark:bg-transparent">
                            ...
                            <section className="p-5 border shadow-sm bg-sky-50/50 dark:bg-sky-500/5 border-sky-100 dark:border-sky-500/20 rounded-2xl">
                                <label className="text-[10px] font-bold uppercase text-slate-500 dark:text-slate-400 tracking-widest block mb-3 border-b border-sky-200 dark:border-sky-500/30 pb-2">Verifikasi Admin</label>
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <p className="text-sm font-medium leading-relaxed text-slate-800 dark:text-slate-300">
                                            {state.verificationoccurringadmin?.keterangan || state.verificationpriorityadmin?.keterangan || <span className="italic text-slate-400">Belum diverifikasi.</span>}
                                        </p>
                                    </div>
                                </div>
                            </section>
                        ...
                        <div className="flex flex-col gap-3 p-5 bg-white border-t shrink-0 border-slate-100 dark:border-slate-800 dark:bg-[#0f172a]">
                             <button onClick={() => openVerification(state)} className="flex items-center justify-center w-full py-2.5 bg-sky-600 hover:bg-sky-700 text-white text-sm font-bold rounded-xl transition-colors shadow-sm focus:ring-2 focus:ring-sky-500/50">
