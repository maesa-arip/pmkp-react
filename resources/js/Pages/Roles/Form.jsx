            ...
            <div className="flex-1 p-4 space-y-6 overflow-y-auto sm:p-6 custom-scrollbar">
                ...
                <div className={sectionCardClass}>
                    <div className={sectionHeaderClass}>
                        <div className="flex items-center">
                            <ShieldCheckIcon className="w-5 h-5 mr-2 text-blue-500 dark:text-blue-400" />
                            <div>
                ...
                <div className={`${sectionCardClass} mb-4`}>
                    <div className={`${sectionHeaderClass} flex items-center justify-between`}>
                        ...
                        <div className="px-3 py-1.5 text-xs font-black text-blue-700 border border-blue-200 rounded-lg bg-blue-50 dark:bg-blue-500/10 dark:text-blue-400 dark:border-blue-500/30">
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-center gap-3 overflow-hidden">
                                            <div className={`flex items-center justify-center w-6 h-6 rounded-md shrink-0 transition-colors ${isSelected ? "bg-blue-200 dark:bg-blue-500/30" : "bg-slate-100 dark:bg-slate-800 group-hover:bg-blue-50 dark:group-hover:bg-blue-500/10"}`}>
                                                <KeyIcon className={`w-3.5 h-3.5 ${isSelected ? "text-blue-700 dark:text-blue-400" : "text-slate-400 dark:text-slate-500 group-hover:text-blue-400"}`} />
                                            </div>
                                            <span className={`text-xs font-bold uppercase tracking-wider truncate ${isSelected ? "text-blue-700 dark:text-blue-400" : "text-slate-700 dark:text-slate-300"}`}>
                                                {permission.name}
                                            </span>
                                        </div>
                                        
                                        <div className={`shrink-0 ml-2 transition-all ${isSelected ? "opacity-100 scale-100" : "opacity-0 scale-75"}`}>
                                            <SolidCheckIcon className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                                        </div>
                                    </div>
                                );
                            })}
