...
export default function Index({ periods, period, nodes, locations, exports, cascadingTree = [], cascadingConcepts = [], cascadingIssues = [], responsiblePositions = [], pics = [], performanceIndicators = [] }) {
