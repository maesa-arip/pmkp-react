...
class RiskRegisterKlinisPengendalianController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('RiskRegister/KlinisPengendalian/Index', [
    ...
    public function update(Request $request, $id)
    {
        $this->validate($request, [
            ...
            'efektif_id' => 'required|numeric|min:1|not_in:0',
            'pengendalian_risiko_harusada' => 'required',
        ]);       
